...
namespace SpyStore.DAL.Tests.Repos
{
    ...
    public class ShoppingCartRepoTests : IDisposable
    {
        ...
        public void ShouldUpdateQuantityOnAddIfAlreadyInCart()
        {
            ...
            _repo.Add(item);
            var shoppingCartRecords = _repo.GetAll().ToList();
            int shoppingCartRecordCount = shoppingCartRecords.Count;
            int shoppingCartRecordQuantity = shoppingCartRecords[0].Quantity;
            Assert.Equal(1, shoppingCartRecordCount);
            Assert.Equal(2, shoppingCartRecordQuantity);
        }
        ...
        public void ShouldUpdateQuantity()
        {
            ...
            int shoppingCartRecordQuantity = shoppingCartRecords[0].Quantity;
            Assert.Equal(1, shoppingCartRecordCount);
            Assert.Equal(5, shoppingCartRecordQuantity);
        }
        ...
        public void ShouldDeleteOnUpdateIfQuantityEqualsZero()
        {
            ...
            var shoppingCartRecords = _repo.GetAll().ToList();
            int shoppingCartRecordCount = shoppingCartRecords.Count;
             Assert.Equal(0, shoppingCartRecordCount);
        }
        ...
        public void ShouldDeleteCartRecord()
        {
            ...
            int cartRecords = _repo.GetAll().Count();
            Assert.Equal(0, cartRecords);
        }
        [Fact]
        ...
        public void ShouldProcessAnOrder()
        {
            ...
            int orderCount = orders1.ToList().Count;
