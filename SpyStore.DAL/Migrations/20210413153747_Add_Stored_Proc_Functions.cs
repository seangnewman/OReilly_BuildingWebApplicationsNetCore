...
{
    public partial class Add_Stored_Proc_Functions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            sql = "CREATE PROCEDURE [Store].[PurchaseItemsInCart] " +
              ...
              "       SELECT @orderId, p.ProductId, Quantity, p.CurrentPrice " +
              "       FROM Store.ShoppingCartRecords scr " +
              "          INNER JOIN Store.Products p ON p.ProductId = scr.ProductId " +
